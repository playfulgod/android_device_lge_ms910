...
$(call inherit-product-if-exists, vendor/lge/revolution/esteem-vendor.mk)
...
PRODUCT_COPY_FILES += \
    ...
    device/lge/esteem/ueventd.bryce.rc:root/ueventd.bryce.rc \
    device/lge/esteem/recovery/postrecoveryboot.sh:root/sbin/postrecoveryboot.sh
...
# HW
PRODUCT_COPY_FILES += \
    device/lge/esteem/prebuilt/lib/hw/sensors.default.so:system/lib/hw/sensors.default.so \
    device/lge/esteem/prebuilt/lib/hw/lights.msm7k.so:system/lib/hw/lights.msm7k.so 
...
#PRODUCT_COPY_FILES += \
    device/lge/esteem/init.bryce.sh:root/init.bryce.sh
